...
urlpatterns = [
    ...
    path('agendar_novamente/<str:id>', views.agendar_novamente, name='agendar_novamente'),
    path('excluir_agendamento/<str:id>', views.excluir_agendamento, name='excluir_agendamento'),
]